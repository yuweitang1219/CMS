...
def generate_content_with_rotation(api_key_str, model_name, prompt):
    ...
    Caches the last successful key index to prevent latency from retrying dead keys sequentially.
    """
    ...
    for attempt in range(num_keys):
        ...
        try:
            ...
            # Success! Cache this working key index
            ...
            _active_key_index = (idx + 1) % num_keys
            last_err = e
